...
abstract class Generator
{
    ...
    public function getRootNamespace()
    {
    	...
    	//	return $this->getModuleRootNamespace();
	 ...
	 * @return string
	 */
	public function getModuleRootNamespace()
	{
		return config('modules.namespace','App\Modules\\').(ucfirst($this->option('module')));
	...
	/**
	 * Check if this need to be created within module
	 * @return bool
	 */
	public function isWithinModule()
	{
